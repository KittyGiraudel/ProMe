...
for (const font of FONTS) {
  ...
  const extra = font.extra ? ` ${font.extra}` : ''
  selectorParts.push(
    `.BiomePage[data-biome='${font.biome}'] .BiomeHero__title { font-family: '${font.family}', serif;${extra} }`
  )
}
...
/* ── Per-biome title font assignments ───────────────────────── */
