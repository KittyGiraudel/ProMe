...
import { isClockDayPhase } from '@/lib/clock/clock'
...
export function ClockDisplay({
  ...
  return (
    <div className='ClockDisplayContainer'>
      <p className='ClockDisplayLabel'>
        {Array.from(t('characters.map.clock_day').toUpperCase()).map(letter => (
      ...
      <p className='ClockDisplayLabel'>
        {Array.from(t('characters.map.clock_night').toUpperCase()).map(
          letter => (
            <span key={letter}>{letter}</span>
          )
        )}
