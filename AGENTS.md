...
- **[Character sheet tabs](docs/character-tabs.md)** — Cosmetic tab architecture for `/characters/[id]`: single-route/single-form behavior, tab section components, and unsaved tab-switch persistence. Read this before changing `src/app/characters/[id]/CharacterSheetClient.tsx` or `src/app/characters/[id]/tabs/`.
